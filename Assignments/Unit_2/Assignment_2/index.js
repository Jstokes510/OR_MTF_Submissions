...
document.getElementById("title").innerHTML = "Welcome to Oakland";
...
function randomSize() {
	let size = Math.floor(Math.random()*58);
	document.getElementById("pageTitle").style.fontSize = "size";
}
// 6. Create an event listener that runs the randomSize function on clic
